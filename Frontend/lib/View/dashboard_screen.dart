...
class _DashboardScreenState extends State<DashboardScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      context.read<MachineStatusViewModel>().startPolling();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return MainLayout(
      ...
      body: Consumer2<DashboardViewModel, MachineStatusViewModel>(
        builder: (context, dashVM, statusVM, child) {
          if (dashVM.isLoading && dashVM.summary == null) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                _buildLiveStatusGrid(context, dashVM, statusVM, isDark),
                const SizedBox(height: 16),
                _buildSplitHUD(context, dashVM, statusVM, isDark),
                const SizedBox(height: 24),
        ...
        if (isWide) {
          ...
          return Column(
            children: [
              ...
              _buildMachinePulseSection(context, dashVM, statusVM, isDark),
            ],
          );
        }
      },
  ...
  Widget _buildFleetIntelligence(
    ...
    double utilization =
        (active /
            (dashVM.allMachines.length > 0 ? dashVM.allMachines.length : 1)) *
        100;
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return InkWell(
                ...
                child: _buildPulseCard(context, machine, status, isDark),
              );
            },
          ),
        ),
              ...
              Container(
                ...
                child: Row(
                  children: [
                    ...
                    if (hasAlert) _PulsingDot(color: Colors.redAccent, size: 8),
                  ],
                ),
              ),
              // Data Grid Segment
                ...
                child: Padding(
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      ...
                      _buildCompactTile(
                        'WATER',
                        status != null ? '${status.waterLevel.toInt()}%' : '--',
                      ...
                      _buildCompactTile(
                        'TEMP',
                        status != null ? '${status.brushTemp.toInt()}°C' : '--',
                      ...
                      _buildCompactTile(
                        'SPEED',
                        status != null ? status.speed.toStringAsFixed(1) : '--',
                        Colors.indigoAccent,
                        Icons.speed_rounded,
                      ),
                      _buildCompactTile(
                        'PERF',
                        status != null ? '${status.areaToday.toInt()}m²' : '--',
                        Colors.blueAccent,
